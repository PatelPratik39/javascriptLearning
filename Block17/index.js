...
const str = prompt("enter some numbers, like this", "1,2,3,3,5,9,12");
...
class Numbers {
  ...
  sum() {
    ...
    // to get sum of the numbers in javascript, we need to use reduce() method where two parameters are mandatory that
    //  accumulator and sum and we need to add it in arrow function
